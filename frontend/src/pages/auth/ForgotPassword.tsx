...
export const ForgotPasswordPage = () => {
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-950/80 p-8 shadow-glow backdrop-blur-xl md:p-12">
      <div className="mb-8">
        <h2 className="text-3xl font-semibold text-slate-900 dark:text-white">Reset your password</h2>
        <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">Enter the email address associated with your account.</p>
      </div>
