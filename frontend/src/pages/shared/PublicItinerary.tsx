      ...
      <div className="grid gap-6 lg:grid-cols-[0.7fr_0.3fr]">
        <Card className="space-y-6">
          <div>
            ...
            <h3 className="mt-2 text-3xl font-semibold text-white">Trip details</h3>
          </div>
          <div className="space-y-4">
            <div className="rounded-3xl border border-white/10 bg-slate-950/80 p-6">
              <p className="text-sm text-slate-400">Title</p>
              <p className="mt-2 text-xl font-semibold text-white">Weekend in Tokyo</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-slate-950/80 p-6">
              <p className="text-sm text-slate-400">Description</p>
              <p className="mt-2 text-sm leading-6 text-slate-300">A dynamic public itinerary built for exploring nightlife, culture, and cuisine in Tokyo.</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-slate-950/80 p-6">
        ...
        <Card className="space-y-6">
          <div>
            ...
            <h3 className="mt-2 text-lg font-semibold text-white">Share this itinerary</h3>
          </div>
          <div className="rounded-3xl border border-white/10 bg-slate-950/80 p-5">
            <p className="text-sm text-slate-400">URL</p>
            <div className="mt-3 rounded-3xl bg-slate-900 px-4 py-3 text-sm text-slate-200">{link || 'Loading link...'}</div>
          </div>
