  ...
  return (
    <label className="block text-sm text-slate-200">
      ...
      <input
        ref={ref}
        className={cn(
          'w-full rounded-2xl border border-slate-800 bg-slate-950 px-4 py-3 text-sm text-slate-100 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20',
